...
Admin---------------------------------项目主要目录
    ...
    Home------------------------------主要接口控制器目录
        ...
        Conf--------------------------当前模块配置文件目录
        Controller--------------------控制器目录
                        AppCodeController.class.php------------------------类目管理控制器
			ApplyVpsController.class.php-----------------------VPS控制器
                        AsynController.class.php---------------------------异步处理数据库分区控制器
			AuthConfController.class.php-----------------------接口调用方法控制器
			...
			CenterItemController.class.php---------------------词库项目控制器
                        ConstantConfigController.class.php-----------------数据字典控制器
                        CouponController.class.php-------------------------优惠码控制器
                        CustomController.class.php-------------------------客户控制器
			CustomTemController.class.php----------------------定制模板控制器
			...
			ProductInfoFormController.class.php----------------资料表与批量表表格控制器
                        Pthread.php----------------------------------------类文件
                        ReadLogController.class.php------------------------读取日志控制器
        ...
        Model------------------------模型目录
                        AuthModel.class.php--------------------------------用户表模型
                        Batch2ProductViewModel.class.php-------------------批量表数据视图
                        BatchFromViewModel.class.php-----------------------数据视图
			Center2GoodViewModel.class.php---------------------产品关联词库与类目视图
                        EnumDictionaryModel.class.php----------------------数据字典模型
			Good2CenterValueViewModel.class.php----------------产品关联词库内容
			Info2ProductViewModel.class.php--------------------资料表数据视图
                        InfoFromViewModel.class.php------------------------数据视图
			TemplateContactViewModel.class.php-----------------批量表模板与资料表模板关联视图
    Opera------------------------------运营系统接口控制器目录
        Common------------------------当前模块公共函数目录
			function------------------公共方法
        Conf--------------------------当前模块配置文件目录
        Controller--------------------控制器目录
			BaseController.class.php---------------------------基本控制器，用于做权限控制
			DataRecordsetController.class.php------------------表单数据控制器
			NumberController.class.php-------------------------编码生成控制器
			PredefindController.class.php----------------------表单编辑控制器
			processController.class.php------------------------流程编辑控制器
			workTaskController.class.php-----------------------工作任务单控制器
        Model------------------------模型目录
			DataComponentModel.class.php-----------------------表单组件模型
			DataFormModel.class.php----------------------------表单模型
			DataRecordsetModel.class.php-----------------------表单元素操作模型
			DataRecordsetViewModel.class.php-------------------表单数据展示视图
			PredefindModel.class.php---------------------------流程模型
                        ProcessModel.class.php-----------------------------流程模型
			ProcessNodeModel.class.php-------------------------流程节点模型
			SysRule4noModel.class.php--------------------------编码模型
			WorkTaskModel.class.php----------------------------工作任务单模型
    Runtime---------------------------缓存日志等目录
...
Thinkphp------------------------------PHP框架系统包
    ThinkPHP\Library\Think\Product----项目分装类
		...
		ImageCategory.class.php--------------------------------图片类目类
                MemcacheCache.class.php--------------------------------memcache缓存类
		PAuth.class.php----------------------------------------权限认证类
		Picture.classs.php-------------------------------------图片类
                Product.class.php--------------------------------------产品信息管理类
                ProductBatchInfo.class.php-----------------------------产品批量表类
