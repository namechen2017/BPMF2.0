...
class ProcessModel extends Model
{
    ...
    protected $tableName = 'process_template';

    
    //获取列表
    public function processList($list_data){
    ...
    //添加
    public function processAdd($add_data){
    ...
    //编辑
    public function processEdit($add_data){
        //哪些字段可以编辑，什么程度的可以编辑，
        $id = (int)$add_data['id'];
        $data = array();
    ...
    //关闭
    public function processClose($uid,$close_data){
